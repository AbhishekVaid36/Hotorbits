...
public class BucketViewItems extends AppCompatActivity implements View.OnClickListener {
    DBHelper mydb;
    ...
    ListView bucketview;
    TextView txtcredit, txtcancel, txtremove, txtorder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Methodexecute();
        customAdapter = new MyCustomAdapter(BucketViewItems.this, cartlistitem, false);
